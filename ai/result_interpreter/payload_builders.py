...
POLICIES = {
    ...
    "iv_curve_comparison": (9, 3, 4, 1, 1, "baseline_candidate_difference_percent"),
    "field_single": (5, 3, 0, 0, 2, "qualitative_only"),
    "field_comparison": (7, 2, 3, 1, 1, "qualitative_only"),
}
...
def build_payload(*, kind: str, context: dict[str, Any], items: list[dict[str, Any]], legacy_comparisons: list[dict[str, Any]], warnings: list[str]) -> AnalysisPayload:
    ...
    payload = AnalysisPayload(_id(analysis_type, normalized_context, subjects), analysis_type, normalized_context, subjects, comparisons, evidence, conclusions, structured_warnings, build_output_policy(analysis_type))
