...
data = devsim.python_packages.pythonmesh.read_gmsh_file(
    str(mesh_path(_EXAMPLE_DIR, "gmsh_mos2d.msh"))
)
...
gmsh_reader(
    mesh="mos2db",
    device="mos2db",
    filename=str(mesh_path(_EXAMPLE_DIR, "gmsh_mos2d.msh")),
)

write_devices(device="mos2da", file=str(mesh_path(_EXAMPLE_DIR, "mos2da.msh")))
write_devices(device="mos2db", file=str(mesh_path(_EXAMPLE_DIR, "mos2db.msh")))

with open(mesh_path(_EXAMPLE_DIR, "mos2da.msh"), "r") as f:
    file1 = f.read()
with open(mesh_path(_EXAMPLE_DIR, "mos2db.msh"), "r") as f:
    file2 = f.read()
