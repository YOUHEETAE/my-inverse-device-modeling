...
def main() -> int:
    ...
    parser.add_argument("--mobility-dir", default="../mobility", help="Path to mobility output folder")
    parser.add_argument("--log-file", default="gmsh_mos2d_run.log", help="Run log filename under mobility folder")
