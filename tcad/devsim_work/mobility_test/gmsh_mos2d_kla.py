...
write_devices(file=str(mesh_path(_EXAMPLE_DIR, "gmsh_mos2d_dd_kla_zero.dat")), type="tecplot")
write_devices(file=str(mesh_path(_EXAMPLE_DIR, "gmsh_mos2d_dd_kla_zero")), type="vtk")
...
write_devices(file=str(mesh_path(_EXAMPLE_DIR, "gmsh_mos2d_dd_kla.dat")), type="tecplot")
write_devices(file=str(mesh_path(_EXAMPLE_DIR, "gmsh_mos2d_dd_kla")), type="vtk")
