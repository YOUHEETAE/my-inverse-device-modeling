  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-between gap-2 py-3 text-left text-sm font-semibold outline-none transition-colors hover:text-primary [&[data-panel-open]_svg]:rotate-180",
          className
        )}
        {...props}
      >
